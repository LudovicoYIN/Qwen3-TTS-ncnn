...
Small audio demos generated by the current C++ dynamic frontend path are in
[samples](samples):
...
| [qwen3_tts_ncnn_long_en_dynamic.wav](samples/qwen3_tts_ncnn_long_en_dynamic.wav) | longer English prompt | 55 | 2.0s |
